...
def show_all_images(
    ...
    real_erosion_deposition = get_erosion_deposition(frame_for_bar, target_img, nonwater, water, pixel_size)
    pred_erosion_deposition = get_erosion_deposition(frame_for_bar, pred_mask, nonwater, water, pixel_size)
